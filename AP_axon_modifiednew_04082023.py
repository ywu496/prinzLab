...
def plotVgeneral(time, voltage, title, total_time, r, c, num):
    plt.subplot(r, c, num)
...
while index2 < 1:
    ...
    while index1 < 1:
        ...
        """
        G_Na_abs_uniform = 300.0 #Na conductance in nS, based on McKinnon Table 1, default is 300nS
        G_Kd_abs_uniform = 200.0 #Kd conductance in nS, based on McKinnon Table 1, default is 2000nS
        ...
        G_A_abs_uniform  = 2 #default 50 nS, used 1, high impact, hyperpolarize
        G_H_abs_uniform  = 1 #default 1nS, used 1, low impact, depolarize
        
        G_M_abs_uniform  = 2 #default 50 nS,used 1, decrease the number spikes, 
        G_CaL_abs_uniform  = 1.2 #default 1.2 nS, used 1.2
        G_KCa_abs_uniform  = 2 #default 50 nS, used 1
        ...
        # initialize compartmental integration parameters
        b1.A = [0.0] #initialize terminal compartment, in units of uS/nF
        b1.B = [-(b1.gNa[0]+b1.gKd[0]+b1.gleak[0]+b1.gGABA[0]+b1.gA[0] + b1.gH[0] + b1.gM[0] + b1.gCaL[0] + b1.gKCa[0]+b1.g_ax_comp)/b1.C_mem_comp] #in units of uS/nF
        b1.C = [b1.g_ax_comp/b1.C_mem_comp] #in units of uS/nF
        b1.D = [(b1.gNa[0]*b1.E_Na+b1.gKd[0]*b1.E_K+b1.gleak[0]*b1.E_leak+b1.gGABA[0]*b1.E_GABA
                 +b1.gA[0]*b1.E_A + b1.gH[0]*b1.E_H + b1.gM[0]*b1.E_M + b1.gCaL[0]*b1.E_CaL + b1.gKCa[0]*b1.E_KCa)/b1.C_mem_comp] #in units of nA/nF
        b1.a = [b1.A[0]*dt] #in units of uS*ms/nF
        b1.b = [b1.B[0]*dt] #in units of uS*ms/nF
        b1.c = [b1.C[0]*dt] #in units of uS*ms/nF
        b1.d = [(b1.D[0]+b1.B[0]*b1.V[0]+b1.C[0]*b1.V[1])*dt] #in units of nA*ms/nF
        print(b1.B)
        print(b1.b)
        for i in range(1, b1.n_comp-1, 1): #initialize compartment integration parameter arrays, for middle compartments
            b1.A.append(b1.g_ax_comp/b1.C_mem_comp) #in units of uS/nF
            b1.B.append(-(b1.gNa[i]+b1.gKd[i]+b1.gleak[i]+b1.gGABA[i]+b1.gA[i] + b1.gH[i] + b1.gM[i] + b1.gCaL[i] + b1.gKCa[i]+2.0*b1.g_ax_comp)/b1.C_mem_comp) #in units of uS/nF
            b1.C.append(b1.g_ax_comp/b1.C_mem_comp) #in units of uS/nF
            b1.D.append((b1.gNa[i]*b1.E_Na+b1.gKd[i]*b1.E_K+b1.gleak[i]*b1.E_leak+b1.gGABA[i]*b1.E_GABA
                         + b1.gA[i]*b1.E_A + b1.gH[i]*b1.E_H + b1.gM[i]*b1.E_M + b1.gCaL[i]*b1.E_CaL + b1.gKCa[i]*b1.E_KCa)/b1.C_mem_comp) #in units of nA/nF
            b1.a.append(b1.A[i]*dt)    
            b1.b.append(b1.B[i]*dt) 
            b1.c.append(b1.C[i]*dt)
            b1.d.append((b1.D[i]+b1.A[i]*b1.V[i-1]+b1.B[i]*b1.V[i]+b1.C[i]*b1.V[i+1])*dt)
        
        b1.A.append(b1.g_ax_comp/b1.C_mem_comp) #in units of uS/nF, for branch compartment
        b1.B.append(-(b1.gNa[b1.n_comp-1]+b1.gKd[b1.n_comp-1]+b1.gleak[b1.n_comp-1]+b1.gGABA[b1.n_comp-1]+b1.g_ax_comp
                      +b1.gA[b1.n_comp-1] + b1.gH[b1.n_comp-1] + b1.gM[b1.n_comp-1] + b1.gCaL[b1.n_comp-1] + b1.gKCa[b1.n_comp-1]+g_main_b1)/b1.C_mem_comp) #in units of uS/nF
        b1.C.append(g_main_b1/b1.C_mem_comp) #in units of uS/nF
        b1.D.append((b1.gNa[b1.n_comp-1]*b1.E_Na+b1.gKd[b1.n_comp-1]*b1.E_K+b1.gleak[b1.n_comp-1]*b1.E_leak+b1.gGABA[b1.n_comp-1]*b1.E_GABA
                     +b1.gA[b1.n_comp-1]*b1.E_A + b1.gH[b1.n_comp-1]*b1.E_H + b1.gM[b1.n_comp-1]*b1.E_M + b1.gCaL[b1.n_comp-1]*b1.E_CaL + b1.gKCa[b1.n_comp-1]*b1.E_KCa)/b1.C_mem_comp) #in units of nA/nF
        b1.a.append(b1.A[b1.n_comp-1]*dt)    
        b1.b.append(b1.B[b1.n_comp-1]*dt) 
        b1.c.append(b1.C[b1.n_comp-1]*dt)
        b1.d.append((b1.D[b1.n_comp-1]+b1.A[b1.n_comp-1]*b1.V[b1.n_comp-2]+b1.B[b1.n_comp-1]*b1.V[b1.n_comp-1]+b1.C[b1.n_comp-1]*V[0])*dt)
        
        b1.A = np.asarray(b1.A)
        b1.B = np.asarray(b1.B)
        b1.C = np.asarray(b1.C)
        b1.D = np.asarray(b1.D)
        b1.a = np.asarray(b1.a)
        b1.b = np.asarray(b1.b)
        b1.c = np.asarray(b1.c)
        b1.d = np.asarray(b1.d)
        ...
        # initialize compartmental integration parameters
        b2.A = [0.0] #initialize first compartment, in units of uS/nF
        b2.B = [-(b2.gNa[0]+b2.gKd[0]+b2.gleak[0]+b2.gGABA[0]+b2.gA[0] + b2.gH[0] + b2.gM[0] + b2.gCaL[0] + b2.gKCa[0]+b2.g_ax_comp)/b2.C_mem_comp] #in units of uS/nF
        b2.C = [b2.g_ax_comp/b2.C_mem_comp] #in units of uS/nF
        b2.D = [(b2.gNa[0]*b2.E_Na+b2.gKd[0]*b2.E_K+b2.gleak[0]*b2.E_leak+b2.gGABA[0]*b2.E_GABA
                 +b2.gA[0]*b2.E_A + b2.gH[0]*b2.E_H + b2.gM[0]*b2.E_M + b2.gCaL[0]*b2.E_CaL + b2.gKCa[0]*b2.E_KCa)/b2.C_mem_comp] #in units of nA/nF
        b2.a = [b2.A[0]*dt] #in units of uS*ms/nF
        b2.b = [b2.B[0]*dt] #in units of uS*ms/nF
        b2.c = [b2.C[0]*dt] #in units of uS*ms/nF
        b2.d = [(b2.D[0]+b2.B[0]*b2.V[0]+b2.C[0]*b2.V[1])*dt] #in units of nA*ms/nF
        
        for i in range(1, b2.n_comp-1, 1): #initialize compartment integration parameter arrays, for middle compartments
            b2.A.append(b2.g_ax_comp/b2.C_mem_comp) #in units of uS/nF
            b2.B.append(-(b2.gNa[i]+b2.gKd[i]+b2.gleak[i]+b2.gGABA[i]+b2.gA[i] + b2.gH[i] + b2.gM[i] + b2.gCaL[i] + b2.gKCa[i]+2.0*b2.g_ax_comp)/b2.C_mem_comp) #in units of uS/nF
            b2.C.append(b2.g_ax_comp/b2.C_mem_comp) #in units of uS/nF
            b2.D.append((b2.gNa[i]*b2.E_Na+b2.gKd[i]*b2.E_K+b2.gleak[i]*b2.E_leak+b2.gGABA[i]*b2.E_GABA
                         + b2.gA[i]*b2.E_A + b2.gH[i]*b2.E_H + b2.gM[i]*b2.E_M + b2.gCaL[i]*b2.E_CaL + b2.gKCa[i]*b2.E_KCa)/b2.C_mem_comp) #in units of nA/nF
            b2.a.append(b2.A[i]*dt)    
            b2.b.append(b2.B[i]*dt) 
            b2.c.append(b2.C[i]*dt)
            b2.d.append((b2.D[i]+b2.A[i]*b2.V[i-1]+b2.B[i]*b2.V[i]+b2.C[i]*b2.V[i+1])*dt)
        
        b2.A.append(b2.g_ax_comp/b2.C_mem_comp) #in units of uS/nF, for last compartment
        b2.B.append(-(b2.gNa[b2.n_comp-1]+b2.gKd[b2.n_comp-1]+b2.gleak[b2.n_comp-1]+b2.gGABA[b2.n_comp-1]+b2.g_ax_comp
                      +b2.gA[b2.n_comp-1] + b2.gH[b2.n_comp-1] + b2.gM[b2.n_comp-1] + b2.gCaL[b2.n_comp-1] + b2.gKCa[b2.n_comp-1]+g_main_b2)/b2.C_mem_comp) #in units of uS/nF
        b2.C.append(g_main_b2/b2.C_mem_comp) #in units of uS/nF
        b2.D.append((b2.gNa[b2.n_comp-1]*b2.E_Na+b2.gKd[b2.n_comp-1]*b2.E_K+b2.gleak[b2.n_comp-1]*b2.E_leak+b2.gGABA[b2.n_comp-1]*b2.E_GABA
                      +b2.gA[b2.n_comp-1]*b2.E_A + b2.gH[b2.n_comp-1]*b2.E_H + b2.gM[b2.n_comp-1]*b2.E_M + b2.gCaL[b2.n_comp-1]*b2.E_CaL + b2.gKCa[b2.n_comp-1]*b2.E_KCa)/b2.C_mem_comp) #in units of nA/nF
        b2.a.append(b2.A[b2.n_comp-1]*dt)    
        b2.b.append(b2.B[b2.n_comp-1]*dt) 
        b2.c.append(b2.C[b2.n_comp-1]*dt)
        b2.d.append((b2.D[b2.n_comp-1]+b2.A[b2.n_comp-1]*b2.V[b2.n_comp-2]+b2.B[b2.n_comp-1]*b2.V[b2.n_comp-1]+b2.C[b2.n_comp-1]*V[0])*dt)
        
        b2.A = np.asarray(b2.A)
        b2.B = np.asarray(b2.B)
        b2.C = np.asarray(b2.C)
        b2.D = np.asarray(b2.D)
        b2.a = np.asarray(b2.a)
        b2.b = np.asarray(b2.b)
        b2.c = np.asarray(b2.c)
        b2.d = np.asarray(b2.d)
        ...
        # BEGIN SIMULATION
        slotList = fireSlots(5, 21, 1/5, 0.2)         #original slotList = fireSlots(5, 28, 1/5, 1)
        while t_now+dt < t_total: 
               ...
               # if t_now>=t_stimstart and t_now<t_stimend:
                ...
                b1.mNa[0] = mNaUpdate(b1.V_old[0], b1.mNa_old[0])
                b1.hNa[0] = hNaUpdate(b1.V_old[0], b1.hNa_old[0])
                b1.gNa[0] = b1.g_mem_Na_comp * np.power(b1.mNa[0], 2) * b1.hNa[0]
        
                # Kd
                b1.nKd[0] = nKdUpdate(b1.V_old[0], b1.nKd_old[0])
                b1.gKd[0] = b1.g_mem_Kd_comp * np.power(b1.nKd[0], 4)
                # leak
                b1.gleak[0] = b1.g_mem_leak_comp 
                
                b1.mA[0] = mAUpdate(b1.V_old[0], b1.mA_old[0])
                b1.hA[0] = hAUpdate(b1.V_old[0], b1.hA_old[0])
                b1.gA[0] = b1.g_mem_A_comp * np.power(b1.mA[0], 3) * b1.hA[0] 
                
                b1.mH[0] = mHUpdate(b1.V_old[0], b1.mH_old[0])
                b1.gH[0] = b1.g_mem_H_comp * b1.mH[0]
                
                b1.mM[0] = mMUpdate(b1.V_old[0], b1.mM_old[0])
                b1.gM[0] = b1.g_mem_M_comp * np.power(b1.mM[0], 2)
                
                b1.mCaL[0] = mCaLUpdate(b1.V_old[0], b1.mCaL_old[0])
                b1.hCaL[0] = hCaLUpdate(b1.V_old[0], b1.hCaL_old[0])
                b1.gCaL[0] = b1.g_mem_CaL_comp * b1.mCaL[0] * b1.hCaL[0]
                
                b1.mKCa[0] = mKCaUpdate(b1.mKCa_old[0], b1.CaS_old[0])
                b1.gKCa[0] = b1.g_mem_KCa_comp * b1.mKCa[0]
                
                b1.CaS[0] = CaSUpdate(b1.CaS_old[0], b1.gCaL[0] * (b1.V_old[0] - b1.E_CaL), b1.comp_vol) #
                #print (b1.gCaL[0] * (b1.V_old[0] - b1.E_CaL))
                
                

                # integration parameters
                b1.A[0] = 0.0 #first compartment, in units of uS/nF
                #####
                b1.B[0] = -(b1.gNa[0]+b1.gKd[0]+b1.gleak[0]+b1.gGABA[0]+b1.gA[0]
                            +b1.gH[0]+b1.gM[0]+b1.gCaL[0]+b1.gKCa[0]+b1.g_ax_comp)/b1.C_mem_comp #in units of uS/nF
                #####
                b1.C[0] = b1.g_ax_comp/b1.C_mem_comp #in units of uS/nF
                #####
                b1.D[0] = (b1.gNa[0]*b1.E_Na+b1.gKd[0]*b1.E_K+b1.gleak[0]*b1.E_leak+b1.gGABA[0]*b1.E_GABA
                           + b1.gA[0]*b1.E_A + b1.gH[0]*b1.E_H + b1.gM[0]*b1.E_M + b1.gCaL[0]*b1.E_CaL + b1.gKCa[0]*b1.E_KCa)/b1.C_mem_comp #in units of nA/nF
                #####
                b1.a[0] = b1.A[0]*dt #in units of uS*ms/nF
                b1.b[0] = b1.B[0]*dt #in units of uS*ms/nF
                b1.c[0] = b1.C[0]*dt #in units of uS*ms/nF
                b1.d[0] = (b1.D[0]+b1.B[0]*b1.V[0]+b1.C[0]*b1.V[1])*dt #in units of nA*ms/nF
        
                b1.b_p[0] = b1.b[0] # _p stands for prime as in Dayan and Abbott appendix 6
                b1.d_p[0] = b1.d[0]
                
                for i in range(1, b1.n_comp-1, 1): #middle compartments
                    # Na
                    b1.mNa[i] = mNaUpdate(b1.V_old[i], b1.mNa_old[i])
                    b1.hNa[i] = hNaUpdate(b1.V_old[i], b1.hNa_old[i])
                    b1.gNa[i] = b1.g_mem_Na_comp * np.power(b1.mNa[i], 2) * b1.hNa[i]
        
                    # Kd
                    b1.nKd[i] = nKdUpdate(b1.V_old[i], b1.nKd_old[i])
                    b1.gKd[i] = b1.g_mem_Kd_comp * np.power(b1.nKd[i], 4)
        
                    # leak
                    b1.gleak[i] = b1.g_mem_leak_comp 
                    
                    b1.mA[i] = mAUpdate(b1.V_old[i], b1.mA_old[i])
                    b1.hA[i] = hAUpdate(b1.V_old[i], b1.hA_old[i])
                    b1.gA[i] = b1.g_mem_A_comp * np.power(b1.mA[i], 3) * b1.hA[i] 
                    
                    b1.mH[i] = mHUpdate(b1.V_old[i], b1.mH_old[i])
                    b1.gH[i] = b1.g_mem_H_comp * b1.mH[i]
                    
                    b1.mM[i] = mMUpdate(b1.V_old[i], b1.mM_old[i])
                    b1.gM[i] = b1.g_mem_M_comp * np.power(b1.mM[i], 2)
                    
                    b1.mCaL[i] = mCaLUpdate(b1.V_old[i], b1.mCaL_old[i])
                    b1.hCaL[i] = hCaLUpdate(b1.V_old[i], b1.hCaL_old[i])
                    b1.gCaL[i] = b1.g_mem_CaL_comp * b1.mCaL[i] * b1.hCaL[i]
                    
        
                    b1.mKCa[i] = mKCaUpdate(b1.mKCa_old[i], b1.CaS_old[i])
                    b1.gKCa[i] = b1.g_mem_KCa_comp * b1.mKCa[i]
                    b1.CaS[i] = CaSUpdate(b1.CaS_old[i], b1.gCaL[i] * (b1.V_old[i] - b1.E_CaL), b1.comp_vol)
                    
                    
                    
                    # integration parameters
                    b1.A[i] = b1.g_ax_comp/b1.C_mem_comp #in units of uS/nF
                    
                    ######
                    b1.B[i] = -(b1.gNa[i]+b1.gKd[i]+b1.gleak[i]+b1.gGABA[i]+b1.gA[i]
                                +b1.gH[i]+b1.gM[i]+b1.gCaL[i]+b1.gKCa[i]+ 2.0*b1.g_ax_comp)/b1.C_mem_comp
                    ######
                    b1.C[i] = b1.g_ax_comp/b1.C_mem_comp #in units of uS/nF
                    #####
                    b1.D[i] = (b1.gNa[i]*b1.E_Na+b1.gKd[i]*b1.E_K+b1.gleak[i]*b1.E_leak+b1.gGABA[i]*b1.E_GABA
                               + b1.gA[i]*b1.E_A + b1.gH[i]*b1.E_H + b1.gM[i]*b1.E_M + b1.gCaL[i]*b1.E_CaL + b1.gKCa[i]*b1.E_KCa)/b1.C_mem_comp
                    #####
                    b1.a[i] = b1.A[i]*dt    
                    b1.b[i] = b1.B[i]*dt
                    b1.c[i] = b1.C[i]*dt
                    b1.d[i] = (b1.D[i]+b1.A[i]*b1.V[i-1]+b1.B[i]*b1.V[i]+b1.C[i]*b1.V[i+1])*dt
                    
                    b1.b_p[i] = b1.b[i] + b1.a[i]*b1.c[i-1]/(1-b1.b_p[i-1]) #equation 6.54 in D&A
                    b1.d_p[i] = b1.d[i] + b1.a[i]*b1.d_p[i-1]/(1-b1.b_p[i-1]) #equation 6.55 in D&A 
                
                #last compartment
                # Na
               
                
                b1.mNa[b1.n_comp-1] = mNaUpdate(b1.V_old[b1.n_comp-1], b1.mNa_old[b1.n_comp-1])
                b1.hNa[b1.n_comp-1] = hNaUpdate(b1.V_old[b1.n_comp-1], b1.hNa_old[b1.n_comp-1])
                b1.gNa[b1.n_comp-1] = b1.g_mem_Na_comp * np.power(b1.mNa[b1.n_comp-1], 2) * b1.hNa[b1.n_comp-1]
        
                # Kd
                b1.nKd[b1.n_comp-1] = nKdUpdate(b1.V_old[b1.n_comp-1], b1.nKd_old[b1.n_comp-1])
                b1.gKd[b1.n_comp-1] = b1.g_mem_Kd_comp * np.power(b1.nKd[b1.n_comp-1], 4)
        
                # leak
                b1.gleak[b1.n_comp-1] = b1.g_mem_leak_comp 
                b1.mA[b1.n_comp-1] = mAUpdate(b1.V_old[b1.n_comp-1], b1.mA_old[b1.n_comp-1])
                b1.hA[b1.n_comp-1] = hAUpdate(b1.V_old[b1.n_comp-1], b1.hA_old[b1.n_comp-1])
                b1.gA[b1.n_comp-1] = b1.g_mem_A_comp * np.power(b1.mA[b1.n_comp-1], 3) * b1.hA[b1.n_comp-1] 
                
                b1.mH[b1.n_comp-1] = mHUpdate(b1.V_old[b1.n_comp-1], b1.mH_old[b1.n_comp-1])
                b1.gH[b1.n_comp-1] = b1.g_mem_H_comp * b1.mH[b1.n_comp-1]
                
                b1.mM[b1.n_comp-1] = mMUpdate(b1.V_old[b1.n_comp-1], b1.mM_old[b1.n_comp-1])
                b1.gM[b1.n_comp-1] = b1.g_mem_M_comp * np.power(b1.mM[b1.n_comp-1], 2)
                
                b1.mCaL[b1.n_comp-1] = mCaLUpdate(b1.V_old[b1.n_comp-1], b1.mCaL_old[b1.n_comp-1])
                b1.hCaL[b1.n_comp-1] = hCaLUpdate(b1.V_old[b1.n_comp-1], b1.hCaL_old[b1.n_comp-1])
                b1.gCaL[b1.n_comp-1] = b1.g_mem_CaL_comp * b1.mCaL[b1.n_comp-1] * b1.hCaL[b1.n_comp-1]
                
                b1.mKCa[b1.n_comp-1] = mKCaUpdate(b1.mKCa_old[b1.n_comp-1], b1.CaS_old[b1.n_comp-1])
                b1.gKCa[b1.n_comp-1] = b1.g_mem_KCa_comp * b1.mKCa[b1.n_comp-1]
                b1.CaS[b1.n_comp-1] = CaSUpdate(b1.CaS_old[b1.n_comp-1], b1.gCaL[b1.n_comp-1] * (b1.V_old[b1.n_comp-1] - b1.E_CaL), b1.comp_vol)
        
                # integration parameters
                
                b1.A[b1.n_comp-1] = b1.g_ax_comp/b1.C_mem_comp #in units of uS/nF
                ####
                b1.B[b1.n_comp-1] = -(b1.gNa[b1.n_comp-1]+b1.gKd[b1.n_comp-1]+b1.gleak[b1.n_comp-1]+b1.gGABA[b1.n_comp-1]
                                      +b1.gA[b1.n_comp-1]+b1.gH[b1.n_comp-1]+b1.gM[b1.n_comp-1]+b1.gCaL[b1.n_comp-1]+b1.gKCa[b1.n_comp-1]
                                      +b1.g_ax_comp+g_main_b1)/b1.C_mem_comp
                #####
                b1.C[b1.n_comp-1] = g_main_b1/b1.C_mem_comp #in units of uS/nF
                #######
                b1.D[b1.n_comp-1] = (b1.gNa[b1.n_comp-1]*b1.E_Na+b1.gKd[b1.n_comp-1]*b1.E_K+b1.gleak[b1.n_comp-1]*b1.E_leak+b1.gGABA[b1.n_comp-1]*b1.E_GABA
                                     + b1.gA[b1.n_comp-1]*b1.E_A + b1.gH[b1.n_comp-1]*b1.E_H + b1.gM[b1.n_comp-1]*b1.E_M + b1.gCaL[b1.n_comp-1]*b1.E_CaL + b1.gKCa[b1.n_comp-1]*b1.E_KCa)/b1.C_mem_comp
                #######
                b1.a[b1.n_comp-1] = b1.A[b1.n_comp-1]*dt    
                b1.b[b1.n_comp-1] = b1.B[b1.n_comp-1]*dt
                b1.c[b1.n_comp-1] = b1.C[b1.n_comp-1]*dt
                b1.d[b1.n_comp-1] = (b1.D[b1.n_comp-1]+b1.A[b1.n_comp-1]*b1.V[b1.n_comp-2]+b1.B[b1.n_comp-1]*b1.V[b1.n_comp-1]+b1.C[b1.n_comp-1]*V[0])*dt
                    
                b1.b_p[b1.n_comp-1] = b1.b[b1.n_comp-1] + b1.a[b1.n_comp-1]*b1.c[b1.n_comp-2]/(1-b1.b_p[b1.n_comp-2]) #equation 6.54 in D&A
                b1.d_p[b1.n_comp-1] = b1.d[b1.n_comp-1] + b1.a[b1.n_comp-1]*b1.d_p[b1.n_comp-2]/(1-b1.b_p[b1.n_comp-2]) #equation 6.55 in D&A
        
                # integrating branch 2 dynamic variables
                # first compartment
                # Na
        
                b2.mNa[0] = mNaUpdate(b2.V_old[0], b2.mNa_old[0])
                b2.hNa[0] = hNaUpdate(b2.V_old[0], b2.hNa_old[0])
                b2.gNa[0] = b2.g_mem_Na_comp * np.power(b2.mNa[0], 2) * b2.hNa[0]
        
                # Kd
                b2.nKd[0] = nKdUpdate(b2.V_old[0], b2.nKd_old[0])
        
                b2.gKd[0] = b2.g_mem_Kd_comp * np.power(b2.nKd[0], 4)
        
                # leak
                b2.gleak[0] = b2.g_mem_leak_comp 
                
                
                
                b2.mA[0] = mAUpdate(b2.V_old[0], b2.mA_old[0])
                b2.hA[0] = hAUpdate(b2.V_old[0], b2.hA_old[0])
                b2.gA[0] = b2.g_mem_A_comp * np.power(b2.mA[0], 3) * b2.hA[0] 
                
                b2.mH[0] = mHUpdate(b2.V_old[0], b2.mH_old[0])
                b2.gH[0] = b2.g_mem_H_comp * b2.mH[0]
                
                b2.mM[0] = mMUpdate(b2.V_old[0], b2.mM_old[0])
                b2.gM[0] = b2.g_mem_M_comp * np.power(b2.mM[0], 2)
                
                b2.mCaL[0] = mCaLUpdate(b2.V_old[0], b2.mCaL_old[0])
                b2.hCaL[0] = hCaLUpdate(b2.V_old[0], b2.hCaL_old[0])
                b2.gCaL[0] = b2.g_mem_CaL_comp * b2.mCaL[0] * b2.hCaL[0]
                
                b2.mKCa[0] = mKCaUpdate(b2.mKCa_old[0], b2.CaS_old[0])
                b2.gKCa[0] = b2.g_mem_KCa_comp * b2.mKCa[0]
                b2.CaS[0] = CaSUpdate(b2.CaS_old[0], b2.gCaL[0] * (b2.V_old[0] - b2.E_CaL), b2.comp_vol)
        
        
                # integration parameters
                b2.A[0] = 0.0 #first compartment, in units of uS/nF
                #####
                b2.B[0] = -(b2.gNa[0]+b2.gKd[0]+b2.gleak[0]+b2.gGABA[0]+b2.gA[0]
                            +b2.gH[0]+b2.gM[0]+b2.gCaL[0]+b2.gKCa[0]+b2.g_ax_comp)/b2.C_mem_comp #in units of uS/nF
                ######
                b2.C[0] = b2.g_ax_comp/b2.C_mem_comp #in units of uS/nF
                #####
                b2.D[0] = (b2.gNa[0]*b2.E_Na+b2.gKd[0]*b2.E_K+b2.gleak[0]*b2.E_leak+b2.gGABA[0]*b2.E_GABA
                           + b2.gA[0]*b2.E_A + b2.gH[0]*b2.E_H + b2.gM[0]*b2.E_M + b2.gCaL[0]*b2.E_CaL + b2.gKCa[0]*b2.E_KCa)/b2.C_mem_comp #in units of nA/nF
                #####
                b2.a[0] = b2.A[0]*dt #in units of uS*ms/nF
                b2.b[0] = b2.B[0]*dt #in units of uS*ms/nF
                b2.c[0] = b2.C[0]*dt #in units of uS*ms/nF
                b2.d[0] = (b2.D[0]+b2.B[0]*b2.V[0]+b2.C[0]*b2.V[1])*dt #in units of nA*ms/nF
        
                b2.b_p[0] = b2.b[0] # _p stands for prime as in Dayan and Abbott appendix 6
                b2.d_p[0] = b2.d[0]
                
                for i in range(1, b2.n_comp-1, 1): #middle compartments
                    # Na
        
                    b2.mNa[i] = mNaUpdate(b2.V_old[i], b2.mNa_old[i])
                    b2.hNa[i] = hNaUpdate(b2.V_old[i], b2.hNa_old[i])
                    b2.gNa[i] = b2.g_mem_Na_comp * np.power(b2.mNa[i], 2) * b2.hNa[i]
        
                    # Kd
         
                    b2.nKd[i] = nKdUpdate(b2.V_old[i], b2.nKd_old[i])
        
                    b2.gKd[i] = b2.g_mem_Kd_comp * np.power(b2.nKd[i], 4)
        
                    # leak
                    b2.gleak[i] = b2.g_mem_leak_comp 
                    
                    
                    
                    b2.mA[i] = mAUpdate(b2.V_old[i], b2.mA_old[i])
                    b2.hA[i] = hAUpdate(b2.V_old[i], b2.hA_old[i])
                    b2.gA[i] = b2.g_mem_A_comp * np.power(b2.mA[i], 3) * b2.hA[i] 
                    
                    b2.mH[i] = mHUpdate(b2.V_old[i], b2.mH_old[i])
                    b2.gH[i] = b2.g_mem_H_comp * b2.mH[i]
                    
                    b2.mM[i] = mMUpdate(b2.V_old[i], b2.mM_old[i])
                    b2.gM[i] = b2.g_mem_M_comp * np.power(b2.mM[i], 2)
                    
                    b2.mCaL[i] = mCaLUpdate(b2.V_old[i], b2.mCaL_old[i])
                    b2.hCaL[i] = hCaLUpdate(b2.V_old[i], b2.hCaL_old[i])
                    b2.gCaL[i] = b2.g_mem_CaL_comp * b2.mCaL[i] * b2.hCaL[i]
        
                    b2.mKCa[i] = mKCaUpdate(b2.mKCa_old[i], b2.CaS_old[i])
                    b2.gKCa[i] = b2.g_mem_KCa_comp * b2.mKCa[i]
                    b2.CaS[i] = CaSUpdate(b2.CaS_old[i], b2.gCaL[i] * (b2.V_old[i] - b2.E_CaL),b2.comp_vol)
                    
                    
                    
                    # integration parameters
                    b2.A[i] = b2.g_ax_comp/b2.C_mem_comp #in units of uS/nF
                    ########
                    b2.B[i] = -(b2.gNa[i]+b2.gKd[i]+b2.gleak[i]+b2.gGABA[i]+b2.gA[i]
                                +b2.gH[i]+b2.gM[i]+b2.gCaL[i]+b2.gKCa[i]+2.0*b2.g_ax_comp)/b2.C_mem_comp
                    #####
                    b2.C[i] = b2.g_ax_comp/b2.C_mem_comp #in units of uS/nF
                    ######
                    b2.D[i] = (b2.gNa[i]*b2.E_Na+b2.gKd[i]*b2.E_K+b2.gleak[i]*b2.E_leak+b2.gGABA[i]*b2.E_GABA
                               + b2.gA[i]*b2.E_A + b2.gH[i]*b2.E_H + b2.gM[i]*b2.E_M + b2.gCaL[i]*b2.E_CaL + b2.gKCa[i]*b2.E_KCa)/b2.C_mem_comp
                    #####
                    b2.a[i] = b2.A[i]*dt    
                    b2.b[i] = b2.B[i]*dt
                    b2.c[i] = b2.C[i]*dt
                    b2.d[i] = (b2.D[i]+b2.A[i]*b2.V[i-1]+b2.B[i]*b2.V[i]+b2.C[i]*b2.V[i+1])*dt
                    
                    b2.b_p[i] = b2.b[i] + b2.a[i]*b2.c[i-1]/(1-b2.b_p[i-1]) #equation 6.54 in D&A
                    b2.d_p[i] = b2.d[i] + b2.a[i]*b2.d_p[i-1]/(1-b2.b_p[i-1]) #equation 6.55 in D&A
                
                
                #last compartment
                # Na
        
                b2.mNa[b2.n_comp-1] = mNaUpdate(b2.V_old[b2.n_comp-1], b2.mNa_old[b2.n_comp-1])
                b2.hNa[b2.n_comp-1] = hNaUpdate(b2.V_old[b2.n_comp-1], b2.hNa_old[b2.n_comp-1])
                b2.gNa[b2.n_comp-1] = b2.g_mem_Na_comp * np.power(b2.mNa[b2.n_comp-1], 2) * b2.hNa[b2.n_comp-1]
        
                # Kd
        
                b2.nKd[b2.n_comp-1] = nKdUpdate(b2.V_old[b2.n_comp-1], b2.nKd_old[b2.n_comp-1])
        
                b2.gKd[b2.n_comp-1] = b2.g_mem_Kd_comp * np.power(b2.nKd[b2.n_comp-1], 4)
        
                # leak
                b2.gleak[b2.n_comp-1] = b2.g_mem_leak_comp 
                
        
                b2.mA[b2.n_comp-1] = mAUpdate(b2.V_old[b2.n_comp-1], b2.mA_old[b2.n_comp-1])
                b2.hA[b2.n_comp-1] = hAUpdate(b2.V_old[b2.n_comp-1], b2.hA_old[b2.n_comp-1])
                b2.gA[b2.n_comp-1] = b2.g_mem_A_comp * np.power(b2.mA[b2.n_comp-1], 3) * b2.hA[b2.n_comp-1] 
                
                b2.mH[b2.n_comp-1] = mHUpdate(b2.V_old[b2.n_comp-1], b2.mH_old[b2.n_comp-1])
                b2.gH[b2.n_comp-1] = b2.g_mem_H_comp * b2.mH[b2.n_comp-1]
                
                b2.mM[b2.n_comp-1] = mMUpdate(b2.V_old[b2.n_comp-1], b2.mM_old[b2.n_comp-1])
                b2.gM[b2.n_comp-1] = b2.g_mem_M_comp * np.power(b2.mM[b2.n_comp-1], 2)
                
                b2.mCaL[b2.n_comp-1] = mCaLUpdate(b2.V_old[b2.n_comp-1], b2.mCaL_old[b2.n_comp-1])
                b2.hCaL[b2.n_comp-1] = hCaLUpdate(b2.V_old[b2.n_comp-1], b2.hCaL_old[b2.n_comp-1])
                b2.gCaL[b2.n_comp-1] = b2.g_mem_CaL_comp * b2.mCaL[b2.n_comp-1] * b2.hCaL[b2.n_comp-1]
                
                b2.mKCa[b2.n_comp-1] = mKCaUpdate(b2.mKCa_old[b2.n_comp-1], b2.CaS_old[b2.n_comp-1])
                b2.gKCa[b2.n_comp-1] = b2.g_mem_KCa_comp * b2.mKCa[b2.n_comp-1]
                b2.CaS[b2.n_comp-1] = CaSUpdate(b2.CaS_old[b2.n_comp-1], b2.gCaL[b2.n_comp-1] * (b2.V_old[b2.n_comp-1] - b2.E_CaL),b2.comp_vol)
        
                # integration parameters
                b2.A[b2.n_comp-1] = b2.g_ax_comp/b2.C_mem_comp #in units of uS/nF
                #######
                b2.B[b2.n_comp-1] = -(b2.gNa[b2.n_comp-1]+b2.gKd[b2.n_comp-1]+b2.gleak[b2.n_comp-1]+b2.gGABA[b2.n_comp-1]
                                      +b2.gA[b2.n_comp-1]+b2.gH[b2.n_comp-1]+b2.gM[b2.n_comp-1]+b2.gCaL[b2.n_comp-1]+b2.gKCa[b2.n_comp-1]
                                      +b2.g_ax_comp+g_main_b2)/b2.C_mem_comp
                #######
                b2.C[b2.n_comp-1] = g_main_b2/b2.C_mem_comp #in units of uS/nF
                #######
                b2.D[b2.n_comp-1] = (b2.gNa[b2.n_comp-1]*b2.E_Na+b2.gKd[b2.n_comp-1]*b2.E_K+b2.gleak[b2.n_comp-1]*b2.E_leak+b2.gGABA[b2.n_comp-1]*b2.E_GABA
                                     + b2.gA[b2.n_comp-1]*b2.E_A + b2.gH[b2.n_comp-1]*b2.E_H + b2.gM[b2.n_comp-1]*b2.E_M + b2.gCaL[b2.n_comp-1]*b2.E_CaL + b2.gKCa[b2.n_comp-1]*b2.E_KCa)/b2.C_mem_comp
                #######
                b2.a[b2.n_comp-1] = b2.A[b2.n_comp-1]*dt    
                b2.b[b2.n_comp-1] = b2.B[b2.n_comp-1]*dt
                b2.c[b2.n_comp-1] = b2.C[b2.n_comp-1]*dt
                b2.d[b2.n_comp-1] = (b2.D[b2.n_comp-1]+b2.A[b2.n_comp-1]*b2.V[b2.n_comp-2]+b2.B[b2.n_comp-1]*b2.V[b2.n_comp-1]+b2.C[b2.n_comp-1]*V[0])*dt
                    
                b2.b_p[b2.n_comp-1] = b2.b[b2.n_comp-1] + b2.a[b2.n_comp-1]*b2.c[b2.n_comp-2]/(1-b2.b_p[b2.n_comp-2]) #equation 6.54 in D&A
                b2.d_p[b2.n_comp-1] = b2.d[b2.n_comp-1] + b2.a[b2.n_comp-1]*b2.d_p[b2.n_comp-2]/(1-b2.b_p[b2.n_comp-2]) #equation 6.55 in D&A
        ...
        plotVgeneral(t, V_rec_first, 'main_V_first', t_total, 3,4,5) #Comment out if you don't want to output the graph
        plotVgeneral(t, V_rec_last, 'V_last', t_total, 3,4,6) #Comment out if you don't want to output the graph
        plotVgeneral(t, b1.V_rec_first, 'b1_V_first', t_total, 3,4,3)
        plotVgeneral(t, b1.V_rec_last, 'b1_V_last', t_total, 3,4,4) #Comment out if you don't want to output the graph
        plotVgeneral(t, b2.V_rec_first, 'b2_V_first', t_total, 3,4,11)
        plotVgeneral(t, b2.V_rec_last, 'b2_V_last', t_total, 3,4,12) #Comment out if you don't want to output the graph
        #plt.suptitle(f'b2_diameter: {b2d_ini + index2 * 0.03}')
        plt.show()
